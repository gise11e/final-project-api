...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { breed: @dog.breed, dob: @dog.dob, image: @dog.image, name: @dog.name } }, as: :json
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { breed: @dog.breed, dob: @dog.dob, image: @dog.image, name: @dog.name } }, as: :json
    assert_response 200
  end
